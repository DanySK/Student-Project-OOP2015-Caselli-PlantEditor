...
\begin{document}
  ...
  \begin{appendices}
    ...
    \begin{figure}[H]
      \centering
      \begin{framed}
        \includegraphics[scale=0.5]{img/application/PersonaModel}
        \includegraphics[scale=0.5]{img/application/PersonaDiagram}
        \includegraphics[scale=0.5]{img/application/PersonaClass}
      \end{framed}
    \end{figure}
    \clearpage
    ...
    \begin{figure}[H]
      \centering
      \begin{framed}
        \includegraphics[scale=0.5]{img/application/ComplexClass}
        \includegraphics[scale=0.5]{img/application/ComplexModel}
        \includegraphics[scale=0.5]{img/application/ComplexDiagram}
      \end{framed}
    \end{figure}
  \end{appendices}
  %-------------------------------------------------------------------------------------------------------------------------------------------------------------
